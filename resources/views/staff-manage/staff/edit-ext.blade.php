                        ...
                        <div class="col-sm-7">
                            <table class="table table-bordered">
                                ...
                                @for($i = 0; $i <= \App\Models\StaffManage\Entry::CREATE_FAMILY_NUM; $i++)
                                    <tr>
                                        <td><input name="family_num[{{$i}}][name]" value="{{!empty($familyNum[$i]['name']) ? $familyNum[$i]['name'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="family_num[{{$i}}][age]" value="{{!empty($familyNum[$i]['age']) ? $familyNum[$i]['age'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="family_num[{{$i}}][relation]" value="{{!empty($familyNum[$i]['relation']) ? $familyNum[$i]['relation'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="family_num[{{$i}}][position]" value="{{!empty($familyNum[$i]['position']) ? $familyNum[$i]['position'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')" name="family_num[{{$i}}][phone]" value="{{!empty($familyNum[$i]['phone']) ? $familyNum[$i]['phone'] : ''}}" style="width: 100%;" type="text"></td>
                                    </tr>
                                @endfor
                                </tbody>
                            </table>
                        ...
                        <div class="col-sm-8">
                            <table class="table table-bordered">
                                ...
                                @for($i = 0; $i <= \App\Models\StaffManage\Entry::CREATE_WORK_HISTORY_NUM; $i++)
                                    <tr>
                                        <td><input name="work_history[{{$i}}][time]" value="{{!empty($workHistory[$i]['time']) ? $workHistory[$i]['time'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="work_history[{{$i}}][deadline]" value="{{!empty($workHistory[$i]['deadline']) ? $workHistory[$i]['deadline'] : ''}}" style="width: 100%;" type="text"></td>
                                        ...
                                        <td><input name="work_history[{{$i}}][position]" value="{{!empty($workHistory[$i]['position']) ? $workHistory[$i]['position'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="work_history[{{$i}}][income]" value="{{!empty($workHistory[$i]['income']) ? $workHistory[$i]['income'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input name="work_history[{{$i}}][boss]" value="{{!empty($workHistory[$i]['boss']) ? $workHistory[$i]['boss'] : ''}}" style="width: 100%;" type="text"></td>
                                        <td><input maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')" name="work_history[{{$i}}][phone]"  value="{{!empty($workHistory[$i]['phone']) ? $workHistory[$i]['phone'] : ''}}" style="width: 100%;" type="text"></td>
                                    </tr>
                                @endfor
                                </tbody>
                            </table>
