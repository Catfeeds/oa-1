            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group @if (!empty($errors->first('nature_id'))) has-error @endif">
                        ...
                        <div class="col-sm-3">
                            {!! Form::select('nature_id', \App\Models\StaffMange\Entry::$nature, isset($user->userExt->nature_id) ? $user->userExt->nature_id: old('nature_id'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {!! Form::select('hire_id', \App\Models\StaffMange\Entry::$hireTYpe, isset($user->userExt->hire_id) ? $user->userExt->hire_id: old('hire_id'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group @if (!empty($errors->first('ethnic'))) has-error @endif">
                        ...
                        <div class="col-sm-3">
                            {!! Form::text('ethnic', isset($user->userExt->ethnic) ? $user->userExt->ethnic: old('ethnic'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group @if (!empty($errors->first('political'))) has-error @endif">
                        ...
                        <div class="col-sm-3">
                            {!! Form::text('political', isset($user->userExt->political) ? $user->userExt->political: old('political'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group @if (!empty($errors->first('school_id'))) has-error @endif">
                        ...
                        <div class="col-sm-3">
                            {!! Form::select('school_id', \App\Models\UserExt::$education, isset($user->userExt->school_id) ? $user->userExt->school_id: old('school_id'), [
                            'class' => 'form-control',
