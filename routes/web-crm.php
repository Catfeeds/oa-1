...
Route::group([
    ...
    Route::get('reconciliation-audit/edit/{id}/{source}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationAudit.edit'],
    ...
    Route::get('reconciliation-audit/review/{status}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationAudit.review'],
        'uses' => 'ReconciliationAuditController@review'])->name('reconciliationAudit.review');
    Route::get('reconciliation-audit/download', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationAudit.download'],
    ...
    Route::get('reconciliation-principal/edit', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationPrincipal.edit'],
    ...
    Route::get('reconciliation-product/create', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationProduct.create'],
    ...
    Route::get('reconciliation-product/edit/{id}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationProduct.edit'],
    ...
    Route::get('reconciliation-difference-type/create/{pid}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationDifferenceType.create'],
    ...
    Route::get('reconciliation-difference-type/edit/{id}/{pid}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationDifferenceType.edit'],
    ...
    Route::get('reconciliation-proportion/edit/{id}/{pid}', [
        'middleware' => ['permission:crm-all|reconciliation-all|reconciliation-reconciliationProportion.edit'],
